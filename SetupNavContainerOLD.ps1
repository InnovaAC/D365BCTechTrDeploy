...
#Innova Docker for BC Translate
$img3 = 'microsoft/bcsandbox:es'
Log "Pulling image $img3"
docker pull $img3

$containerName = 'navdemoBCT'
...
New-NavContainer -accept_eula `
    ...
    -credential $credential `
    -additionalParameters $additionalParameters `
    -licenseFile 'c:\demo\licenseBCT.flf' `
    -imageName $img3

$country = Get-NavContainerCountry -containerOrImageName $img3
$navVersion = Get-NavContainerNavVersion -containerOrImageName $img3
$locale = Get-LocaleFromCountry $country
